        ...
        <div>
            ...
            <div className='lg:w-[80%] m-auto'>
                ...
                <Stack height={"lg:592px"} className="mt-20 sm:text-center lg:text-left" direction={"row"} justifyContent={"space-between"} flexWrap={"wrap"}>
                    <Box padding={"0px 48px"} className="flex flex-col justify-center sm:items-center lg:items-start lg:w-[676px] h-[512px] sm:m-auto" data-aos="flip-left"
                    >
                    ...
                    <Box width={"676px"} height={"512px"} className="sm:m-auto" data-aos="flip-right"
                    >
